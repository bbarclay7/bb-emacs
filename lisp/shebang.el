...
(defun shebang-check-interpreter ()
  ...
  (save-excursion                   ; file is shebang'd
    (goto-char 1)
    (if
        (re-search-forward "^#![ ]?\\([a-zA-Z_\-./]+\\)" 550 t) ; int. < 50-2 chars
        (let ((prefix-function-name t)
