#+TITLE: AI-Assisted Development with bb-emacs
...
To use it interactively in a terminal: ~ollama run qwen3-coder-32k~
...
To run models interactively in separate terminals:
- Terminal 1: ~ollama run qwen3-coder~ (coding)
- Terminal 2: ~ollama run deepseek-r1:70b~ (reasoning/planning)
- Terminal 3: ~ollama run qwen2.5-coder:7b~ (quick iterations)

Use coding model in Emacs via gptel, reasoning model for architecture/planning, fast model for iterations.
...
- [[https://github.com/karthink/gptel][gptel - Simple LLM Client for Emacs]]
- [[https://www.alcarney.me/blog/2024/local-llms-with-ollama-and-gptel/][TIL: Local LLMs with Ollama and gptel]]
- [[https://github.com/s-kostyaev/ellama][Ellama - LLM Tool for Emacs]]
- [[https://www.dyerdwelling.family/emacs/20250207092636-emacs--ollama-buddy-local-llm-integration-for-emacs/][Ollama Buddy - Local LLM Integration]]
- [[https://github.com/MatthewZMD/aidermacs][Aidermacs - AI Pair Programming]]
- [[https://willschenk.com/labnotes/2024/ai_in_emacs/][AI in Emacs - Will Schenk]]

** Agentic Coding Tools

- [[https://aider.chat/docs/][Aider Official Documentation]]
- [[https://aider.chat/docs/git.html][Aider Git Integration]]
- [[https://aider.chat/docs/repomap.html][Aider Repository Map]]
- [[https://blog.openreplay.com/getting-started-aider-ai-coding-terminal/][Getting Started with Aider]]
- [[https://www.blott.com/blog/post/aider-review-a-developers-month-with-this-terminal-based-code-assistant][Aider Review: A Developer's Month]]

** Comparisons & Benchmarks

- [[https://research.aimultiple.com/agentic-cli/][Agentic CLI Tools Compared: Claude Code vs Cline vs Aider]]
- [[https://www.qodo.ai/blog/claude-code-vs-cursor/][Claude Code vs Cursor Deep Comparison]]
- [[https://render.com/blog/ai-coding-agents-benchmark][Testing AI Coding Agents 2025]]
- [[https://www.faros.ai/blog/best-ai-coding-agents-2026][Best AI Coding Agents 2026]]
- [[https://dev.to/murat_aslan_fa44b545aaa2c/the-complete-guide-to-local-ai-coding-in-2026-205l][The Complete Guide to Local AI Coding in 2026]]

** Latest Model Releases (2025)

- [[https://medium.com/@cognidownunder/qwen3-coder-alibabas-game-changing-open-source-agentic-ai-coding-model-3cf34dcc8d7a][Qwen3-Coder: Alibaba's Game-Changing Agentic AI Coding Model]]
- [[https://www.alizila.com/alibaba-unveils-new-qwen3-models-for-coding-complexing-reasoning-and-machine-translation/][Alibaba Unveils Qwen3 Models for Coding]]
- [[https://winbuzzer.com/2025/07/23/alibaba-targets-agentic-ai-crown-with-qwen3-coder-release-xcxwbn/][Alibaba Targets Agentic AI Crown with Qwen3-Coder]]
- [[https://www.datacamp.com/tutorial/qwen3-ollama][How to Set Up and Run Qwen3 Locally With Ollama]]

** Local AI Coding Alternatives

- [[https://github.com/TabbyML/tabby][Tabby - Self-hosted AI Coding Assistant]]
- [[https://continue.dev/][Continue.dev - Open Source AI Code Assistant]]
- [[https://www.virtualizationhowto.com/2025/05/best-self-hosted-github-copilot-ai-coding-alternatives/][Best Self-hosted AI Coding Alternatives]]
- [[https://jasongiroux.com/2024/12/11/local-copilot/][Replacing GitHub Copilot with Ollama]]
- [[https://www.femaleswitch.com/directories/tpost/6yvgmjs4b1-top-10-open-source-alternatives-to-githu][Top 10 Open Source AI Coding Tools]]
- [[https://github.com/srikanth235/privy][Privy - Open Source AI Assistant]]
- [[https://github.com/fauxpilot/fauxpilot][FauxPilot - Self-hosted Coding Assistant]]

** Ollama & Local Models

- [[https://ollama.com/][Ollama Official Site]]
- [[https://github.com/ollama/ollama][Ollama GitHub Repository]]
- [[https://markaicode.com/ollama-code-generation-ai-programming-assistant/][Ollama Code Generation Tutorial]]
- [[https://markaicode.com/continue-dev-ollama-ai-code-completion-tutorial/][Continue.dev with Ollama]]

** Model Information

- *Qwen3-Coder* (Latest): [[https://github.com/QwenLM/Qwen3-Coder][GitHub]] | [[https://www.alibabacloud.com/blog/alibaba-unveils-cutting-edge-ai-coding-model-qwen3-coder_602399][Announcement]] | [[https://ollama.com/library/qwen3-coder][Ollama Library]]
- *Qwen3*: [[https://github.com/QwenLM/Qwen3][GitHub]] | [[https://qwenlm.github.io/blog/qwen3/][Official Blog]]
- *DeepSeek R1* (Reasoning): [[https://github.com/deepseek-ai/DeepSeek-R1][GitHub]] | [[https://ollama.com/library/deepseek-r1][Ollama Library]]
- *Qwen2.5-Coder*: [[https://github.com/QwenLM/Qwen2.5-Coder][GitHub]]
- *DeepSeek-Coder*: [[https://github.com/deepseek-ai/DeepSeek-Coder][GitHub]]
- *CodeLlama*: [[https://github.com/facebookresearch/codellama][GitHub]]
...
2. *Pull latest models*:
   ...
   #+end_src
3. *⚠️ CRITICAL: Configure 32k context* (see [[#context-window-optimization--critical][Context Window Optimization]] section):
   #+begin_src bash
   cat > Modelfile << 'EOF'
   FROM qwen3-coder
   PARAMETER num_ctx 32768
...
*Back to:* [[file:README.org][Main README]] | [[file:README.org::*Structure][Structure]] | [[file:README.org::*Installation][Installation]]
